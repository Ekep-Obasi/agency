      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-accent-200">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link
                  ...
                  className="text-neutral-300 hover:text-primary-300 transition duration-150 ease-in-out"
                >
                  Documentation
                </Link>
              </li>
              ...
              <li className="mb-2">
                <Link
                  href="https://keploy.io/sitemap.xml"
                  className="text-neutral-300 hover:text-primary-300 transition duration-150 ease-in-out"
                >
                  Sitemap
                </Link>
          ...
          <div className="sm:col-span-6 md:col-span-4 lg:col-span-3">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <Link
                  href="https://keploy.io/docs/privacy-policy/"
                  className="text-neutral-300 hover:text-primary-300 transition duration-150 ease-in-out"
                >
                  Privacy Policy
                </Link>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <div className="text-sm text-neutral-300 mr-4">
            &copy; Keploy Inc 2023. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
