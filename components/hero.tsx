      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20 gap-16">
          ...
          <div className=" text-center pb-12 md:pb-16">
            <p
              className="text-xl sm:text-2xl text-accent-200 mb-4 leading-snug sm:leading-normal"
              data-aos="zoom-y-out"
              data-aos-delay="150"
            >
            ...
            <div className="max-w-3xl mx-auto">
              ...
              >
                ...
                <div>
                  <Link
                    className="btn text-white bg-green-900 hover:text-emerald-200 w-full sm:w-auto sm:ml-4"
