...
export const featuresData = [
  {
    ...
    description:
      "Generate and execute contract tests automatically, reducing manual efforts and errors with Keploy",
  },
  {
    title: "Cross-Language Support",
    icon: <ManualStubCreationIcon />,
    description:
      "Supports multiple programming languages, allowing for consistent contract testing across different services.",
  },
  {
    title: "Scalable Testing",
    icon: <ScalabilityTestingDifficultiesIcon />,
    description:
      "Efficiently handle large and complex service architectures, ensuring thorough contract validation.",
  },
  {
    title: "Detailed Reporting",
    icon: <DataVariabilityConcernsIcon />,
    description:
      "Keploy provides comprehensive reports on contract test results, facilitating easy analysis and troubleshooting.",
  },
  {
    title: "Error Detection",
    icon: <CollaborationIcon />,
    description:
      "Quickly identify and resolve contract mismatches to ensure reliability in API interactions.",
  },
];
