...
export const featuresData = [
  {
    ...
    description:
      "Integrate Keploy testsuite effortlessly with popular CI tools such as GitHub, GitLab, Jenkins etc.. in your workflow.",
  },
  {
    title: "Continuos Integration",
    icon: <ManualStubCreationIcon />,
    description:
      "Seamlessly integrate Keploy with Jest for automated testing workflows, ensuring compatibility with popular testing frameworks.",
  },
  {
    title: "No Environment Setup",
    icon: <ScalabilityTestingDifficultiesIcon />,
    description:
      "Eliminate the hassle of setting up testing environments when using Keploy in your CI pipeline.",
  },
  {
    title: "Faster Development Workflow",
    icon: <DataVariabilityConcernsIcon />,
    description:
      "Improve your development workflow, ensuring reliable and high-quality software delivery, with quick and informative feedback with Keploy's capabilities.",
  },
  {
    title: "Scalable Testing Infrastructure",
    icon: <ErrorHandlingChallengesIcon />,
    description:
      "Scale your testing infrastructure effortlessly with Keploy's parallel test execution capabilities in CI/CD pipeline.",
  },
  {
    title: "Continuous Testing in DevOps",
    icon: <CollaborationIcon />,
    description:
      "Enhance your DevOps practices with continuous integration and testing with Keploy, ensuring consistent software quality throughout the development lifecycle.",
  },
];
export const faqQuestions = [
  {
    title:
      "How to integrate Keploy with continuous integration (CI) tools like GitHub and Jenkins?",
    answer:
  ...
  {
    title:
      " Is Keploy compatible with different operating systems and platforms?",
    answer:
  ...
  {
    title:
      "Does Keploy require setting up testing environments separately in CI pipelines?",
    answer:
  ...
  {
    title:
      "Does Keploy accelerate feedback loops in continuous integration testing?",
    answer:
