...
export const featuresData = [
  ...
  },
  {
    ...
    description:
      "Keploy can is an open source API testing tool, providing developers with a cost-effective solution for comprehensive testing.",
  },
  {
    title: "Automated API Test Generation",
    icon: <DataVariabilityConcernsIcon />,
    description:
      "Test cases are automatically generated based on recorded interactions, saving time and effort in test script creation.",
  },
  {
    title: "Dynamic Mocks",
    icon: <ScalabilityTestingDifficultiesIcon />,
    description:
      "Keploy provides dynamic mock data, making your tests more realistic. With which, you can test your API without relying on external services or dependencies.",
  },
  {
    title: "Real-time Test Execution",
    icon: <ErrorHandlingChallengesIcon />,
    description:
      "Keploy enables real-time test execution, allowing developers to receive immediate feedback on API functionality and performance.",
  },
  {
    title: "Comprehensive Reporting",
    icon: <ManualStubCreationIcon />,
    description:
      "Keploy provides comprehensive test reports, enabling developers to analyze test results and identify areas for improvement quickly.",
  },
];
...
export const faqQuestions = [
  ...
  {
    title:
      "How does Keploy simplify test automation across different languages and frameworks?",
    answer:
