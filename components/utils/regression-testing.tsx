...
export const featuresData = [
  {
    ...
    description:
      " Keploy automates regression testing to ensure software stability over time.",
  },
  {
    title: "Efficient Test Execution",
    icon: <ManualStubCreationIcon />,
    description:
      "Keploy enables efficient execution of regression tests, saving time and resources.",
  },
  {
    title: "Continuous Testing",
    icon: <ScalabilityTestingDifficultiesIcon />,
    description:
      "Implement automated regression testing in software development cycles for continuous improvement.",
  },
  {
    title: "Customize Testing Scenarios",
    icon: <DataVariabilityConcernsIcon />,
    description:
      "With Keploy you can tailor regression testing scenarios to match specific software requirements.",
  },
  {
    title: "Early Bug Detection",
    icon: <CollaborationIcon />,
    description:
      "Keploy excels in regression testing in software testing by accurately detecting bugs introduced by new code changes.",
  },
];
