...
export const blocksData = [
  {
    ...
    description:
      "Automatically generated test cases may vary in quality, leading to tests that lack the depth and precision required to catch edge cases or subtle bugs.",
    SvgComponent: MdiLightningBolt,
  },
  {
    title: "False Sense of Security",
    description:
      "Relying heavily on test case generation tools may create a false sense of security, as generated tests might not cover all critical paths, resulting in missed defects.",
    SvgComponent: FluentPuzzleCubePiece20Filled,
  },
  {
    title: "High Learning Curve",
    description:
      "Developers often face a steep learning curve when integrating automated test case generation tools into their workflows, requiring additional training and time to adapt.",
    SvgComponent: CollaborationIcon,
  },
  {
    title: "Limited Customization",
    description:
      "Generated test cases may not fully address the specific needs or intricacies of a project, requiring significant manual adjustments to align with complex scenarios.",
    SvgComponent: StreamlineBrowserCheck,
  },
  {
    title: "Test Redundancy",
    description:
      "Test case generation tools can create redundant or unnecessary tests, cluttering the test suite and increasing maintenance efforts without adding value to the testing process.",
    SvgComponent: PsPiggyBankCoins,
  },
  {
    title: "Dependency on Tools",
    description:
      "Over-reliance on automated test generation tools can make teams dependent on these tools, potentially leading to gaps in testing when the tools cannot handle certain scenarios effectively.",
