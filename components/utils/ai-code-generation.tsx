...
export const featuresData = [
  {
    ...
    description:
      "Keploy uses AI to create tests automatically, reducing manual effort and ensuring thorough coverage.",
  },
  {
    title: "Automated E2E Testing",
    icon: <ManualStubCreationIcon />,
    description:
      "Keploy simplifies automated unit testing by generating test cases based on actual usage patterns.",
  },
  {
    title: "Enhanced Test Accuracy",
    icon: <ScalabilityTestingDifficultiesIcon />,
    description:
      "With AI-generated tests, Keploy ensures more accurate and reliable testing outcomes.",
  },
  {
    title: "Easy Integration",
    icon: <DataVariabilityConcernsIcon />,
    description:
      "Integrating Keploy into your workflow is straightforward, making AI-generated tests and automated unit testing accessible to all developers.",
  },
  {
    title: "Reduced Development Time",
    icon: <CollaborationIcon />,
    description:
      "Keploy’s automated unit testing speeds up the development process, allowing for quicker releases.",
  },
];
export const faqQuestions = [
  ...
  {
    title:
      "What is the primary benefit of using Keploy for automated unit testing?",
    answer:
