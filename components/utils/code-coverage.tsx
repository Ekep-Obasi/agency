...
export const featuresData = [
  {
    ...
    description:
      "Keploy automates code coverage analysis, making it easier and faster.",
  },
  {
    title: "Code Coverage Support",
    icon: <ManualStubCreationIcon />,
    description:
      "Keploy supports integration with python code coverage, and similarly with jest, junit, ensuring comprehensive testing of your applications.",
  },
  {
    title: "Dynamic Test Generation",
    icon: <ScalabilityTestingDifficultiesIcon />,
    description:
      "Keploy dynamically generates tests based on real user interactions, improving code coverage.",
  },
  {
    title: "Comprehensive Reporting",
    icon: <DataVariabilityConcernsIcon />,
    description:
      "Keploy provides detailed reports on complete code coverage including line, statement & branch, helping you identify areas for improvement.",
  },
  {
    title: "Streamlined Workflow",
    icon: <ErrorHandlingChallengesIcon />,
    description:
      "With Keploy, you can streamline your testing workflow for better code coverage and software reliability.",
  },
];
export const faqQuestions = [
  ...
  {
    title:
      "How can I combine my Keploy tests with frameworks like pyTest or Jest ?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Keploy offers a comprehensive solution to unit test coverage by seamlessly integrating with existing unit tests. It allows developers to merge Keploy-generated tests with their current unit tests, enhancing overall coverage and ensuring robust software delivery.",
  },
  {
    title:
      "Can Keploy help streamline my testing workflow for better code coverage??",
    answer:
      "Absolutely, Keploy helps streamline your testing workflow, ensuring better code coverage and software reliability.",
  },
];
