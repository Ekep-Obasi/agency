      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-6 md:pb-10">
            <h1 className="h1 mb-4 text-secondary-300">
              Test smart - Build better
            </h1>
            <h3 className="h3 text-xl text-gray-600">
              {" "}
              &nbsp; ❌ &nbsp; Just say no to &nbsp; ❌ &nbsp;{" "}
            </h3>
            <div className="flex text-gray-600 pt-3 pl-6 pr-6">
              <svg
                ...
                className="mx-auto mt-2 md:invisible"
              >
                <path
                  d="M3.64644 39.3536C3.84171 39.5488 4.15829 39.5488 4.35355 39.3536L7.53553 36.1716C7.73079 35.9763 7.73079 35.6597 7.53553 35.4645C7.34027 35.2692 7.02369 35.2692 6.82843 35.4645L4 38.2929L1.17157 35.4645C0.976309 35.2692 0.659727 35.2692 0.464465 35.4645C0.269202 35.6597 0.269202 35.9763 0.464465 36.1716L3.64644 39.3536ZM3.5 -2.18558e-08L3.5 39L4.5 39L4.5 2.18558e-08L3.5 -2.18558e-08Z"
                  fill="#111827"
                ></path>
              </svg>
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="mx-auto mt-2 invisible md:visible"
              >
                <path
                  d="M3.64644 39.3536C3.84171 39.5488 4.15829 39.5488 4.35355 39.3536L7.53553 36.1716C7.73079 35.9763 7.73079 35.6597 7.53553 35.4645C7.34027 35.2692 7.02369 35.2692 6.82843 35.4645L4 38.2929L1.17157 35.4645C0.976309 35.2692 0.659727 35.2692 0.464465 35.4645C0.269202 35.6597 0.269202 35.9763 0.464465 36.1716L3.64644 39.3536ZM3.5 -2.18558e-08L3.5 39L4.5 39L4.5 2.18558e-08L3.5 -2.18558e-08Z"
                  fill="#111827"
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none ">
            ...
            <div className="hidden md:flex relative  flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Unseen network calls hinder testing and analysis of software
                behavior.
              </p>
            </div>
            ...
            <div className="hidden relative md:flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Underperforming code leading to critical problems and
                inefficiencies.
              </p>
            </div>
            ...
            <div className="hidden relative md:flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Difficult-to-reproduce production issues locally for testing and
                debugging.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Multiple env complicates testing, stub preparation and are
                unrealistic.
              </p>
            </div>
          </div>
