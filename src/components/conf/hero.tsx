  ...
  return (
    <section>
      <div className=" max-w-6xl mx-auto px-4 sm:px-6 relative">
        <div
          className="absolute left-0 bottom-0 -ml-20 lg:block pointer-events-none"
          aria-hidden="true"
          data-aos="fade-up"
          data-aos-delay="400"
        >
        ...
        <div className="relative pt-32 pb-10 md:pt-56 md:pb-16">
          ...
          <div className="max-w-6xl mx-auto text-center pb-12 md:pb-16">
            <h3 className="h3 mt-16 mb-4 font-semibold " data-aos="fade-up">
              Event where Open Source meets Practical Productivity
            </h3>

            <h3
              className="h3 mb-16 whitespace-pre font-architects-daughter text-primary-400"
              data-aos="fade-up"
            >
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up " data-aos-delay="400">
                <Link
                  className="btn rounded-lg text-white bg-secondary-300 hover:text-primary-300 w-full mb-4 sm:w-auto sm:mb-0"
                  target="_blank"
                  href="https://forms.gle/9ABV4QosARLBB8Vc7"
                >
                  Register
                  <svg
                    className=" ml-3 w-3 h-3 shrink-0 fill-current"
                    viewBox="0 0 23 23"
                  >
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <Link
                  className="btn rounded-lg text-white border-primary-400 border-1 bg-transparent hover:text-primary-300 w-full sm:w-auto sm:ml-4"
                  target="_blank"
                  href="https://forms.gle/iwZRL4UD2Pw1redaA"
                >
                  Submit CFP
                </Link>
              </div>
            ...
            <div className=" mt-3 mb-5 md:bottom-8 md:left-12 z-60 sm:max-w-none sm:flex sm:justify-center">
              <div className="text-slate-50 text-sm p-3 md:rounded ">
                <div className="text-slate-500 inline-flex">
                  <Link
                    className="text-lg font-semibold hover:underline text-slate-50"
                    href="https://forms.gle/9ABV4QosARLBB8Vc7"
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <span className="text-lg font-semibold italic px-1.5">
                    {' '}
                    at{' '}
                  </span>
                  <Link
                    className="text-lg font-semibold hover:underline text-primary-300 justify-center "
                    href="https://maps.app.goo.gl/jo9zKhjDAgMqE92m6"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Google RMZ, Bengaluru
                  </Link>
                </div>
