...
export default function ModalVideo({
  ...
  return (
    <div className="relative">
      ...
      <div>
        <div
          className="relative flex justify-center z-10 mb-8"
          data-aos="zoom-y-out"
          data-aos-delay="450"
        >
          ...
          <button
            className="absolute top-full flex items-center transform -translate-y-1/2 bg-white rounded-full font-medium group p-4 shadow-lg hover:bg-primary-300"
            onClick={() => {
              setModalOpen(true);
            }}
          >
            <svg
              className="w-6 h-6 fill-current text-gray-400 group-hover:text-accent-200 shrink-0"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <span className="ml-3 hover:text-secondary-300">
              Watch demo (1 min)
            </span>
          </button>
        </div>
